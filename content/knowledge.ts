...
export const knowledgeContent = [
  ...
  { ...publicActive, id: "K2", title: "AI 产品岗位匹配", keywords: ["匹配", "岗位", "ai产品经理", "能力", "短板", "缺口", "核实", "为什么"], content: "匹配证据包括应用统计学与评测意识、财务及 IT 审计的业务理解、多项公开 RAG 与 Agent 项目，以及持续把问题转化为可运行工具。当前证据缺口是大规模商业化、真实用户增长和长期跨职能团队管理。", verification: "self_attested", candidateContribution: "候选人负责项目问题定义、产品取舍、评测与工程审核。", aiAssistance: "AI 编程工具参与代码实现，候选人负责需求、验证和边界管理。", limitations: "这是岗位证据分析，不是录用结论；贡献范围与业务结果需面试核实。", claimIds: ["C2", "C3", "C4", "C6", "C8"], supportsClaimIds: ["C2", "C3", "C4", "C6", "C8"], sourceIds: ["S1", "S3", "S4", "S10"] },
  ...
  { ...publicActive, id: "K4", title: "企业级 RAG 知识库系统", keywords: ["rag", "知识库", "检索", "ragas", "milvus", "代表项目", "项目"], relatedProject: "rag-knowledge-base", content: "从审计非结构化文档检索痛点出发，设计并实现支持多格式解析、混合检索、Rerank、引用溯源和自动评测的 RAG 知识库系统。", projectStatus: "completed", verification: "externally_verified", candidateContribution: "主导产品定位、检索策略、评测体系与全栈落地。", aiAssistance: "AI 编程工具辅助开发、调试与文档整理。", limitations: "长期记忆在仓库 README 中标记为规划项，不能描述为已完成；生产规模需核实。", claimIds: ["C3"], supportsClaimIds: ["C3"], sourceIds: ["S1", "S3"] },
  { ...publicActive, id: "K5", title: "DeepFlow 多 Agent 研究工作台", keywords: ["deepflow", "agent", "多agent", "研究", "planner", "researcher", "报告"], relatedProject: "deepflow", content: "DeepFlow 通过 Coordinator、Planner、Researcher、Coder 和 Reporter 等角色完成研究计划、资料检索、分析和报告生成，并支持人审确认与成果物输出。", projectStatus: "completed", verification: "externally_verified", candidateContribution: "设计 Agent 分工、过程可解释性、观测字段与报告资产链路。", aiAssistance: "模型承担研究生成，AI 编程工具辅助工程实现。", limitations: "引用数量、时延和成本取决于具体任务，不能视为稳定 SLA。", claimIds: ["C4"], supportsClaimIds: ["C4"], sourceIds: ["S1", "S4"] },
